...
for RANDOM_SEED in $RANDOM_SEEDS; do
    ...
    MODEL_URL="gs://vcm-ml-experiments/default/2022-10-06/ml-on-fine-res-train-nn-noflux-rs-trial-0/trained_models/model${RANDOM_SEED}"
    EXPERIMENT="ml-on-fine-ensemble-noflux-${RANDOM_SEED}"
    TRIAL="trial-0"
